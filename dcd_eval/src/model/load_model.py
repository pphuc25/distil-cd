...
def get_model_master_and_amateur(args):
    ...
    if args.constractive_prompt_student and not args.quantize_4bit_student and not args.student_name_or_path and not args.fp16:
        return model, None
    if not args.student_name_or_path and not args.quantize_4bit_student and not args.fp16:
        return model, None
